...
export class LessonsDetailsComponent implements OnInit {
    ...
    ngOnInit() {
        this.routeSub = this.route.params.subscribe(params => {
            ...
            .subscribe(userMenResponse => {
                ...
                this.http.get(this.configService.getLessonsByIdUrl(this.lessonId), this.httpOptions)
                    .subscribe(response => {
                        this.lessonsData = response;
                        this.editForm.controls.classesId.setValue(this.lessonsData.classesId);
                        this.editForm.controls.coursesId.setValue(this.lessonsData.coursesId);
                        this.editForm.controls.teachers.setValue(this.lessonsData.teachers);
						this.editForm.controls.title.setValue(this.lessonsData.session);
						this.editForm.controls.fromDate.setValue(this.lessonsData.date);
						this.editForm.controls.startTime.setValue(this.lessonsData.startTime);
						this.editForm.controls.endTime.setValue(this.lessonsData.endTime);
						this.editForm.controls.studentNum.setValue(this.lessonsData.studentNum);
                        this.progressMode = 'determinate';
                        this.progressValue = 100;
                    }, error => {
                        this.navigationService.changeUrl('lessons/' + this.lessonId);
                    });
	...
	getSessionErrorMessage() {
        return this.editForm.controls.session.hasError('required') ? 'Please enter session' :
            '';
    }

	getDateErrorMessage() {
        return this.editForm.controls.date.hasError('required') ? 'Please select from date' :
            '';
    }
    ...
    onSubmit() {
        ...
        if (this.editForm.valid) {
            ...
            this.http.patch(this.configService.getLessonsByIdUrl(this.lessonId), this.editForm.value, this.httpOptions)
                .subscribe( response => {
